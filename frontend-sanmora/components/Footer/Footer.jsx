    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.linksGrid}>
          ...
          <div className={styles.linkGroup}>
            ...
            <a href="tel:+91 8780005326" className={styles.contactLink}>+91 87800 05326</a>
            <a href="mailto:info@sanmora.in" className={styles.contactLink}>info@sanmora.in</a>
          </div>
        </div>
      </div>
      ...
      <div className={styles.bottomBar}>
        ...
        <div className={styles.socials}>
          ...
          <a href="https://wa.me/918780005326" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="WhatsApp">
            <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
